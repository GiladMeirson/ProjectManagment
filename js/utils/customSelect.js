...
const SELECT_COLORS = {
  /* Status */
  'ממתין':                    { bg: '#dfe7ff', fg: '#000000' },
  'בעבודה':                   { bg: '#ffd6d6', fg: '#000000' },  
  'נשלחו תוכניות לעיון':      { bg: '#ffe7c2', fg: '#000000' },  
  'נשלחו תוכניות מעודכנות':   { bg: '#fff3bf', fg: '#000000' },  
  'נשלחו תוכניות למכרז':      { bg: '#f1f7c6', fg: '#000000' },  
  'נשלחו תוכניות לביצוע':     { bg: '#d6f5d6', fg: '#000000' },  
